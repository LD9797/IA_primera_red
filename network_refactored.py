...
class Network(object):
    ...
    def __init__(self, sizes, type_cost_f, type_forward_f):
    ...
    def derivative_cost_function(self, x, y):
        if self.type_cost_function == 0:
            return functions.cost_derivative(x, y)
    ...
    def forward_function(self, z):
        ...
        if self.type_cost_function == 2:
            return functions.softmax(z)

    def prime_forward_function(self, z):
        if self.type_cost_function == 0 or self.type_cost_function == 2:
...
# Epoches 6
    ...
    def backprop(self, x, y):
        ...
        primera_derivada = self.prime_forward_function(zs[-1])
